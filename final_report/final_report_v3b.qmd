...
Our analysis uses a county-level dataset combining data from the **Inter-university Consortium for Political and Social Research (ICPSR)** and the **Bureau of Labor Statistics (BLS)**:
